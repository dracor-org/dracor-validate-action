...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
   <title>ISO Schematron rules (DraCor Schema 1.3.0)</title>
   <!-- This file generated 2026-02-14T16:17:13Z by 'extract-isosch.xsl'. -->
   <!-- ********************* -->
   <!-- namespaces, declared: -->
   <!-- ********************* -->
   ...
   <ns prefix="sch1x" uri="http://www.ascc.net/xml/schematron"/>
   <!-- ******************************************************* -->
   <!-- constraints in en, und, mul, zxx, of which there are 99 -->
   <!-- ******************************************************* -->
   ...
   <pattern id="schematron-constraint-play_sub_title-27">
   ...
   <pattern id="schematron-constraint-identifier_corpus_name_in_corpus_xml-28">
      <rule context="tei:teiCorpus/tei:teiHeader/tei:fileDesc/tei:publicationStmt"
            role="critical">
         <assert test="tei:idno[@type eq 'URI' and @xml:base='https://dracor.org/']"> The corpus.xml must define the corpus name in an &lt;idno&gt; element of @type "URI" and an @xml:base of ""https://dracor.org/"". E.g. &lt;idno type="URI" xml:base="https://dracor.org/"&gt;ger&lt;/idno&gt;.</assert>
      </rule>
   </pattern>
   <pattern id="schematron-constraint-corpus_repository_url_in_corpus_xml-29">
      <rule context="tei:teiCorpus/tei:teiHeader/tei:fileDesc/tei:publicationStmt"
            role="warning">
         <assert test="tei:idno[@type eq 'repo']"> The corpus.xml should specify the GitHub repository of the corpus using an &lt;idno&gt; element of the @type "repo".</assert>
      </rule>
   </pattern>
   <pattern id="schematron-constraint-licence_target_url-30">
   ...
   <pattern id="schematron-constraint-digital_original_source_in_sourceDesc-31">
   ...
   <pattern id="schematron-constraint-sources_count_and_nesting-32">
   ...
   <pattern id="schematron-constraint-digital_source_use_ref-33">
   ...
   <pattern id="schematron-constraint-digital_source_availability-34">
      <rule context="tei:TEI/tei:teiHeader/tei:fileDesc/tei:sourceDesc/tei:bibl[@type eq 'digitalSource']"
            role="warning"
            see="https://dracor.org/doc/odd#section-sources">
   ...
   <pattern id="schematron-constraint-quotationContents-35">
   ...
   <pattern id="schematron-constraint-citestructure-outer-match-36">
   ...
   <pattern id="schematron-constraint-citestructure-inner-match-37">
   ...
   <pattern id="schematron-constraint-xml_model_or_type_dracor_on_root_tei_element-38">
   ...
   <pattern id="schematron-constraint-valid_dracor_ids_on_root_tei_element-39">
      <rule context="tei:TEI" role="warning">
         <assert test="matches(./@xml:id,'^[a-z]+[0-9]{6}$')"> For DraCor IDs we recommend the pattern ^[a-z]+[0-9]{6}$</assert>
      </rule>
   </pattern>
   <pattern id="schematron-constraint-network_check_basic_play_structure_div-40">
   ...
   <pattern id="schematron-constraint-network_check_basic_play_structure_sp-41">
      <rule context="tei:body" role="warning">
   ...
   <pattern id="schematron-constraint-network_play_without_speaking_characters-42">
   ...
   <pattern id="schematron-constraint-abstractModel-structure-div-in-l-43">
   ...
   <pattern id="schematron-constraint-abstractModel-structure-div-in-ab-or-p-44">
   ...
   <pattern id="schematron-constraint-linkTargets3-45">
   ...
   <pattern id="schematron-constraint-abstractModel-structure-ab-in-l-46">
   ...
   <pattern id="schematron-constraint-person_sex-49">
   ...
   <pattern id="schematron-constraint-personGrp_sex-50">
   ...
   <pattern id="schematron-constraint-play_id-60">
      <rule context="/"
            role="information"
   ...
   <pattern id="schematron-constraint-play_wikidata_id-61">
      <rule context="/"
            role="information"
   ...
   <pattern id="schematron-constraint-play_title-62">
      <rule context="/"
            role="information"
   ...
   <pattern id="schematron-constraint-play_subtitle-63">
      <rule context="/"
            role="information"
   ...
   <pattern id="schematron-constraint-play_year_written-64">
      <rule context="/"
            role="information"
   ...
   <pattern id="schematron-constraint-play_year_printed-65">
      <rule context="/"
            role="information"
   ...
   <pattern id="schematron-constraint-encoding-hint_play_wikidata_id-66">
      <rule context="tei:TEI/tei:standOff/tei:listRelation/tei:relation[@name eq 'wikidata']"
         ...
         <assert test="./@active/string() eq $expected_play_uri"> The value of the attribute '@active' SHOULD follow the pattern "https://dracor.org/entity/{play_id}. [Expected value: '<value-of select="$expected_play_uri"/>']"</assert>
      </rule>
   </pattern>
</schema>
