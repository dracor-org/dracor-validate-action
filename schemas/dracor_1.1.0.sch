...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
   <title>ISO Schematron rules (DraCor Schema 1.1.0)</title>
   <!-- This file generated 2025-12-20T13:23:47Z by 'extract-isosch.xsl'. -->
   <!-- ********************* -->
   <!-- namespaces, declared: -->
   <!-- ********************* -->
   ...
   <ns prefix="sch1x" uri="http://www.ascc.net/xml/schematron"/>
   <!-- ******************************************************* -->
   <!-- constraints in en, und, mul, zxx, of which there are 97 -->
   <!-- ******************************************************* -->
   ...
   <pattern id="schematron-constraint-play_sub_title-27">
      <rule context="tei:titleStmt[count(tei:title[not(@xml:lang)]) &gt; 1]"
            role="warning">
   ...
   <pattern id="schematron-constraint-digital_source_in_sourceDesc-31">
      <rule context="tei:sourceDesc">
         <assert test="tei:bibl[@type eq 'digitalSource']"> Digital source is missing</assert>
      </rule>
   </pattern>
   <pattern id="schematron-constraint-original_source_in_sourceDesc-32">
   ...
   <pattern id="schematron-constraint-quotationContents-33">
   ...
   <pattern id="schematron-constraint-citestructure-outer-match-34">
   ...
   <pattern id="schematron-constraint-citestructure-inner-match-35">
   ...
   <pattern id="schematron-constraint-xml_model_or_type_dracor_on_root_tei_element-36">
   ...
   <pattern id="schematron-constraint-abstractModel-structure-ab-in-l-44">
   ...
   <pattern id="schematron-constraint-person_sex-47">
   ...
   <pattern id="schematron-constraint-personGrp_sex-48">
