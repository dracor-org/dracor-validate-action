...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
   <title>ISO Schematron rules (DraCor Schema 1.4.0)</title>
   <!-- This file generated 2026-04-19T13:51:37Z by 'extract-isosch.xsl'. -->
   <!-- ********************* -->
   <!-- namespaces, declared: -->
   <!-- ********************* -->
   ...
   <ns prefix="sch1x" uri="http://www.ascc.net/xml/schematron"/>
   <!-- ******************************************************** -->
   <!-- constraints in en, und, mul, zxx, of which there are 101 -->
   <!-- ******************************************************** -->
   ...
   <pattern id="schematron-constraint-network_sp_with_who_attr-24">
   ...
   <pattern id="schematron-constraint-network_unlinked_sp-25">
   ...
   <pattern id="schematron-constraint-play_sub_title-26">
   ...
   <pattern id="schematron-constraint-corpus_xml_corpus_name-27">
   ...
   <pattern id="schematron-constraint-corpus_xml_corpus_name_syntax-28">
   ...
   <pattern id="schematron-constraint-corpus_xml_repository_url-29">
      <rule context="/(tei:teiCorpus|tei:dracorCorpus)/tei:teiHeader/tei:fileDesc/tei:publicationStmt"
            see="https://dracor.org/doc/odd#section-corpus-xml"
            role="warning">
   ...
   <pattern id="schematron-constraint-corpus_xml_deprecation-30">
   ...
   <pattern id="schematron-constraint-licence_target_url-31">
   ...
   <pattern id="schematron-constraint-digital_original_source_in_sourceDesc-32">
   ...
   <pattern id="schematron-constraint-sources_count_and_nesting-33">
   ...
   <pattern id="schematron-constraint-digital_source_use_ref-34">
   ...
   <pattern id="schematron-constraint-digital_source_availability-35">
      <rule context="tei:TEI/tei:teiHeader/tei:fileDesc/tei:sourceDesc/tei:bibl[@type eq 'digitalSource']"
            role="warning"
            see="https://dracor.org/doc/odd#section-sources">
   ...
   <pattern id="schematron-constraint-quotationContents-36">
   ...
   <pattern id="schematron-constraint-citestructure-outer-match-37">
   ...
   <pattern id="schematron-constraint-citestructure-inner-match-38">
   ...
   <pattern id="schematron-constraint-xml_model_or_type_dracor_on_root_tei_element-39">
   ...
   <pattern id="schematron-constraint-valid_dracor_ids_on_root_tei_element-40">
      <rule context="tei:TEI" role="warning">
         <assert test="matches(./@xml:id,'^[a-z]+[0-9]{6}$')"> For DraCor IDs we recommend the pattern ^[a-z]+[0-9]{6}$</assert>
      </rule>
   </pattern>
   <pattern id="schematron-constraint-network_check_basic_play_structure_div-41">
   ...
   <pattern id="schematron-constraint-network_check_basic_play_structure_sp-42">
      <rule context="tei:body" role="warning">
   ...
   <pattern id="schematron-constraint-network_play_without_speaking_characters-43">
   ...
   <pattern id="schematron-constraint-abstractModel-structure-div-in-l-44">
   ...
   <pattern id="schematron-constraint-abstractModel-structure-div-in-ab-or-p-45">
   ...
   <pattern id="schematron-constraint-linkTargets3-46">
   ...
   <pattern id="schematron-constraint-abstractModel-structure-ab-in-l-47">
   ...
   <pattern id="schematron-constraint-deprecate-standoff-events-50">
   ...
   <pattern id="schematron-constraint-person_sex-51">
   ...
   <pattern id="schematron-constraint-personGrp_sex-52">
   ...
   <pattern id="schematron-constraint-play_id-62">
      <rule context="/"
            role="information"
   ...
   <pattern id="schematron-constraint-play_wikidata_id-63">
      <rule context="/"
            role="information"
   ...
   <pattern id="schematron-constraint-play_title-64">
      <rule context="/"
            role="information"
   ...
   <pattern id="schematron-constraint-play_subtitle-65">
      <rule context="/"
            role="information"
   ...
   <pattern id="schematron-constraint-play_year_written-66">
      <rule context="/"
            role="information"
   ...
   <pattern id="schematron-constraint-play_year_printed-67">
      <rule context="/"
            role="information"
   ...
   <pattern id="schematron-constraint-encoding-hint_play_wikidata_id-68">
